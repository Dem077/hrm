...
class StoreRemoteDoorSiteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'zkt_device_id' => [
                'required',
                'integer',
                Rule::exists('zkt_devices', 'id')->where('machine_type', ZktMachineType::Access->value),
            ],
            'name' => ['required', 'string', 'max:255'],
            'code' => ['nullable', 'string', 'max:50', Rule::unique('remote_door_sites', 'code')],
