...
trait ValidatesDesignationPayrollItems
{
    /**
     * @return array<string, mixed>
     */
    protected function designationPayrollItemRules(): array
    {
        return [
            ...
            'items.*.loan_bank' => ['nullable', Rule::enum(PayrollLoanBank::class)],
        ];
    }

    public function validateDesignationPayrollItems(Validator $validator): void
    {
